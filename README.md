...
* **Tested & Verified:** Achieved 96% frontend test coverage using Jest and React Testing Library.
* **Enterprise Code Quality:** 0 bugs, 0 vulnerabilities, and 0 code smells verified via SonarCloud analysis.
...
2. Navigate to the backend directory, run `npm install`, add your `.env` variables (MongoDB URI, JWT Secret), and start the server.
